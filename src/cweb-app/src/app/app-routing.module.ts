...
const routes: Routes = [
  ...
  {path: 'settings',
    title: 'settings', component: LazyWrapperComponent,
     // canActivate: [AuthGuard], 
  ...
  {path: 'cdr',
    title: 'cdr', component: LazyWrapperComponent, 
    // canActivate: [AuthGuard], 
    resolve: {reconnectUpdater: UnsubscribeService}},
  {path: 'logs',
    title: 'logs', component: LazyWrapperComponent, 
    // canActivate: [AuthGuard], 
    resolve: {reconnectUpdater: UnsubscribeService}},
  {path: 'fs-cli',
    title: 'fs-cli', component: LazyWrapperComponent,
     // canActivate: [AuthGuard],
      resolve: {reconnectUpdater: UnsubscribeService}},
  {path: 'hep',
    title: 'hep', component: LazyWrapperComponent, 
    // canActivate: [AuthGuard], 
    resolve: {reconnectUpdater: UnsubscribeService}},
  {
