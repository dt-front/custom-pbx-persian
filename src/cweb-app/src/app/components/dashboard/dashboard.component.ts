  ...
  ngOnInit() {
    ...
    this.cards = this.breakpointObserver.observe(Breakpoints.Handset).pipe(
      map(({ matches }) => {
        if (matches) {
          return [
            { title: 'کارت ۱', type: '', show: false },
            { title: 'کارت ۲', type: '', show: false },
            { title: 'کارت ۳', type: '', show: false },
            { title: 'کارت ۴', type: '', show: false },
            { title: 'کارت ۵', type: '', show: false },
            { title: 'کارت ۶', type: '', show: false },
            { title: 'کارت ۷', type: '', show: false },
          ];
        }

        return [
          {
            title: 'پروفایل‌های SIP',
            class: 'two-cols',
            type: 'table',
